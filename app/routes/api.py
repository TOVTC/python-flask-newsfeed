...
# this is a PUT method because Post is ultimately what uses the Vote information
...
# uses id parameter again - SQLAlchemy requires you query the database for the record and update it before recommiting it
